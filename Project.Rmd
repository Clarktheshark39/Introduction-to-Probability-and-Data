...
Now that we have observed a clear decrease in sleep as reported general health decreases, let's look into the relationship between sleep and exercise. To do this, I will split the data into 8 evenly split groups based on the amount of sleep reported and look at the amoung of exercise reported for each group.

```{r}
sleep <- brfss2013[!(is.na(brfss2013$sleptim1)), ]
sleep <- subset(sleep, sleep$sleptim1 > 0 & sleep$sleptim1 < 24)
